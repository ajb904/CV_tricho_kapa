...
contig.data[,'coding.snprate'] <- contig.data$coding.vars / contig.data$ContigLength
contig.data[,'intergenic.snprate'] <- contig.data$intergenic.vars / contig.data$ContigLength
```